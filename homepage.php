                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class=" mt-5 row justify-content-center" style='img'>
                                <img src="http://127.0.0.1/medical/img/1.png" class='img-fluid img-thumbnail' alt="Responsive image">
                            </div>
                    </div>
                    <!-- dashboard -->
                        ...
                        <div class="row">
                            <div class="col-sm-5 ml-5 m-2">
                                <div class="card mb-3" style="max-width: 540px;">
                                    <div class="row no-gutters">
                                        <div class="col-md-4">
                                        <img src="http://127.0.0.1/medical/img/icons/3.png" class="card-img" alt="...">
                                        </div>
                                        <div class="col-md-8">
                                        <div class="card-body">
                            ...
                            <div class="col-sm-5 m-2">
                                <div class="card mb-3" style="max-width: 540px;">
                                        <div class="row no-gutters">
                                            <div class="col-md-4">
                                            <img src="http://127.0.0.1/medical/img/icons/5.png" class="card-img" alt="...">
                                            </div>
                                            <div class="col-md-8">
                                            <div class="card-body">
                            ...
                            <div class="col-sm-5 ml-5 m-2">
                                <div class="card mb-3" style="max-width: 540px;">
                                        <div class="row no-gutters">
                                            <div class="col-md-4">
                                            <img src="http://127.0.0.1/medical/img/icons/6.png" class="card-img" alt="...">
                                            </div>
                                            <div class="col-md-8">
                                            <div class="card-body">
                            ...
                            <div class="col-sm-5 m-2">
                                <div class="card mb-3" style="max-width: 540px;">
                                        <div class="row no-gutters">
                                            <div class="col-md-4">
                                            <img src="http://127.0.0.1/medical/img/icons/2.png" class="card-img" alt="...">
                                            </div>
                                            <div class="col-md-8">
                                            <div class="card-body">
                        ...
                        <?php
                            if(isset($_POST['pati'])){
                                if($_POST['name']!='' || $_POST['lname']!='' || $_POST['email']!=''|| $_POST['mnumber']!='' || $_POST['add']!='' ){
                                    ...
                                    $pin=$_POST['zip'];
                                    $gender = $_POST['gender'];
                                    $img= 'http://127.0.0.1/medical/img/profileimg/';
