...
<html>
    ...
    <body style="background-image: url('http://127.0.0.1/medical/img/1.bmp'); background-repeat:no-repeat; background-position: center;">
    <div class="container pt-5 row no-gutters "> 
        <div class="rounded col-md-4 offset-md-7 rounded text-black " style="background-color: #008080;">
            <div class="col bg-white text-center p-2">
                <img src="http://127.0.0.1/medical/img/logo1.bmp" alt=""  style='height:5rem; width:5rem;'>
            </div>  
...
if(isset($_POST['submit'])){
    ...
    if(!$conn){
        ...
        if($new==1){
            $_SESSION['username'] = $u;
            echo "<script> location.href='http://127.0.0.1/medical/homepage.php'</script>";
        }
    }
}
?>  